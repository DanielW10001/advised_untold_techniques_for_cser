...
![](_v_images/20200827085125237_17161.png)
...
我们在GitHub上注册账号并登录后, 需要先上传自己的SSH公钥. 选择右上角用户头像>Settings>SSH and GPG keys, 填写一个便于识别的标题, 然后把用户主目录下的`.ssh/id_rsa.pub`文件的内容粘贴进去. 若没有`id_rsa.pub`, 请参阅`ssh-keygen`
